...
if __name__=='__main__':
    #part-r-0 to part-r-31 is data
    for i in range(10, 32):
        if i <= 9:
            text_path = 'step0' + str(i) + '.txt'
            out_path = '../finish/finish0' + str(i) + '.txt'
        else:
            text_path = 'step' + str(i) + '.txt'
            out_path = '../finish/finish' + str(i) + '.txt'
        # processing(text_path, out_path)
        processing('htmltest.txt', 'result.txt')
        print 'done'
